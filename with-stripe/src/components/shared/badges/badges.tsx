...
const addonOnlyColors = Object.fromEntries(
  Object.entries(outlinedColors).map(([key, value]) => [
    key,
...
const withPillTypes = {
  ...
  [badgeTypes.pillOutline]: {
    common:
      'size-max flex items-center whitespace-nowrap rounded-full ring-[1.5px] ring-inset',
    ...
    <span
      ...
      <button
        ...
        className={cx(
          ...
          type === 'pill-color' || type === 'pill-outline'
            ? 'rounded-full'
            : 'rounded-[3px]'
        )}
