...
export const InputBase = forwardRef<HTMLElement, InputBaseProps>(
  (
    ...
    const handleOnChange = (event: StripeCardExpiryElementChangeEvent) => {
...
export const CardExpiry = forwardRef<HTMLDivElement, InputProps>(
  (
    {
      size = 'sm',
      placeholder,
    ...
    const handleClick = () => {
      element?.getElement(CardExpiryElement)?.focus();
    };
...
CardExpiry.displayName = 'CardExpiry';
