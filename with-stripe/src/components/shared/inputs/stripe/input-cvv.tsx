...
export const InputBase = forwardRef<HTMLElement, InputBaseProps>(
  (
    ...
    const handleOnChange = (event: StripeCardCvcElementChangeEvent) => {
...
export const CardCVC = forwardRef<HTMLDivElement, InputProps>(
  (
    {
      size = 'sm',
      placeholder,
    ...
    const handleClick = () => {
      element?.getElement(CardCvcElement)?.focus();
    };
